...
Aaruni Kaushik\authorOrcid{0009-0006-3061-6553}\authorRef{8},
...
\authlabel{8} Fachbereich Mathematik, Rheinland-Pfälzische Technische Universität Kaiserslautern-Landau, 67663 Kaiserslautern, Germany\\
}
...
\subsection{SFB-TRR 195 - Symbolic Tools in Mathematics and their Application, Kaiserslautern, Aachen, Saarbruecken, Berlin, Darmstadt, Siegen, Stuttgart, Tuebingen}
...
a next-generation computer algebra system, named OSCAR (Open Source Computer Algebra Research).
