...
\authlabel{9} Fachbereich Mathematik, Rheinland-Pfälzische Technische Universität Kaiserslautern-Landau, 67663 Kaiserslautern, Germany,\\
...
A particular focus is placed on the use of [JTrack](https://jtrack.readthedocs.io/en/latest/index.html) and [DataLad](https://www.datalad.org/) for mobile data collection and distributed data management, respectively.
...
For example, its components are in production use within the [SFB1451](https://www.crc1451.uni-koeln.de/) and [ABCD-J (Accessing Behavior for Clinical Data and Joint Usage)](https://abcd-j.de/) networks.
...
\subsection{Project INF - Data Management for Reproducible Data-Driven Computational Modeling Cross-Species and Cross-Labs, \href{https://gepris.dfg.de/gepris/projekt/458705875?language=en}{Key Mechanisms of Motor Control in Health and Disease}, Univeristy of Cologne, European Neuroscience Institute Göttingen, Goethe University Frankfurt, Hebrew University of Jerusalem, University of Münster, German Center for Neurodegenerative Diseases, Forschungszentrum Jülich, Max Planck Institute for Biology of Ageing, Max Planck Institute for Metabolism Research}
...
[DataLad](https://www.datalad.org/) is the main RDM solution adopted by the SFB to address the challenge of introducing structure and version control to, ensuring reproducibility of, and supporting collaboration on heterogeneous data and workflows across projects with very different experimental setups and analysis methods.
