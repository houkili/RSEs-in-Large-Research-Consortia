...
\subsection{Project INF --- Information Infrastructure, \href{https://www.sfb1638.de/}{SFB1638 --- Cellular Membrane Remodelling -- How Changing Form Creates Function}, Heidelberg, Mannheim}
...
\subsection{\href{https://www.computeralgebra.de/sfb/}{SFB-TRR 195 - Symbolic Tools in Mathematics and their Application}, Kaiserslautern, Aachen, Saarbruecken, Berlin, Darmstadt, Siegen, Stuttgart, Tuebingen}
...
interdisciplinary methods. SFB-TRR 195 was established in 2017 to meet these challenges and develop
...
extension of products within the OSCAR unvierse.
...
\href{https://www.crc1451.uni-koeln.de/}{SFB1451}
and
...
\subsection{Project INF - Data Management for Reproducible Data-Driven Computational Modeling Cross-Species and Cross-Labs, \href{https://gepris.dfg.de/gepris/projekt/458705875?language=en}{SFB1451 - Key Mechanisms of Motor Control in Health and Disease}, Univeristy of Cologne, European Neuroscience Institute Göttingen, Goethe University Frankfurt, Hebrew University of Jerusalem, University of Münster, German Center for Neurodegenerative Diseases, Forschungszentrum Jülich, Max Planck Institute for Biology of Ageing, Max Planck Institute for Metabolism Research}

This INF project operates at the interface of computational neuroscience, data management, and scientific computing, supporting the overarching goal of SFB1451 to understand motor control across biological scales and species.
...
The INF project is embedded in a broad network within the SFB1451, working closely with experimental and computational projects across all domains and acting as a central hub for data handling and exchange.
\href{https://www.datalad.org/)}{DataLad} is the main RDM solution adopted by the SFB to address the challenge of introducing structure and version control to, ensuring reproducibility of, and supporting collaboration on heterogeneous data and workflows across projects with very different experimental setups and analysis methods.


\subsection{Project INF - Infrastructure, \href{https://trr391.tu-dortmund.de/}{Spatio-temporal Statistics for the Transition of Energy and Transport}
...
MM acknowledges the funding from DFG, SFB 1646/1 2024 -- \geprislink{512393437}, project INF.
ND acknowledges the funding from DFG, SFB 1638, project INF - project number \geprislink{511488495}.
JSG and MH acknowledge funding from the DFG through the TRR 379 "Neuropsychobiology of Aggression", project INF - project number \geprislink{512007073}, and the SFB 1451 "Key Mechanisms of Motor Control in Health and Disease", project INF - project number \geprislink{458705875}.
\end{acknowledge}
