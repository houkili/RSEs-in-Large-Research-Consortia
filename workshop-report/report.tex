...
Our project is interdisciplinary, bringing together the three principal investigators Alexander Mehler (computer science), Manfred Sailer and Sol Lago (linguistics), as well as collaborators from both disciplines, including Nasimeh Bahmanian, Giuseppe Abrahami, Andy Lücking, Leon Hammerla, and Mercedes Martinez Bruera. This interdisciplinarity is both the project’s major strength and one of its main challenges. The challenge is further amplified by the fact that NegLaB’s scientific questions explicitly depend on cross-linguistic and cross-method integration. As a result, infrastructure decisions affect not only individual projects, but also how easily results can be compared and integrated across the CRC. One important contribution has been the setup of a server that allows CRC members to implement, share, and run experiments online using open-source software like PCIbex \parencite{zehr_schwarz_2018_pcibex}. Additionally, we developed a platform for collecting metadata for each project’s data. This was particularly important because the platform had to be flexible enough to accommodate very different types of data, including theoretical, experimental, and fieldwork-based materials.

Collaboration with the library services of Goethe University Frankfurt has been an important part of our work. Together, we developed a CRC-wide data management protocol and established data management plans for each project using the Research Data Management Organiser (RDMO).
This collaboration has also helped increase the visibility of INF's research data management initiatives, as these have been presented and discussed at events organized by the library services. Beyond our host institution, we are in contact with \href{https://www.uni-marburg.de/en/hefdi/about-hefdi}{HefDi}, 
...
version control systems (e.g., Git/GitHub), documentation standards, and structured
...
Findability of the respective resposible users is a problem.
